...
import com.zjht.adv.util.PostPaySignature;
import com.zjht.adv.util.PropertyUtil;

public class PaymentInfoForPost {
	...
	public boolean isCallbackMatch() {
		boolean isCallbackMatch = PostPaySignature.enCodeByCer(this.getCallbackSignStr(), this.getSignContent(), this.getPublicKeyName());
	...
	public String getSignContent() {
		...
		if (StringUtils.isBlank(this.signContent)) {
			this.signContent = PostPaySignature.encodeMsgByPrivateKey(this.getPrivateKeyPath(), this.getSignStr(), this.getPrivateKeyPsw());
		}
		return signContent;
	}
	...
	public String getPrivateKeyPath() {
		return privateKeyPath != null ? privateKeyPath : PropertyUtil.getPropertyValueDir("app", "post_private_key_name");
	}
	...
	public String getPrivateKeyPsw() {
		return privateKeyPsw != null ? privateKeyPsw : PropertyUtil.getPropertyValueDir("app", "post_private_key_psw");
	}
	...
	public String getPublicKeyName() {
		return publicKeyName != null ? publicKeyName : PropertyUtil.getPropertyValueDir("app", "post_public_key_file_name");
	}
	...
	public String getPlatformPayUrl() {
		return platformPayUrl != null ? platformPayUrl : PropertyUtil.getPropertyValueDir("app", "post_platform_pay_url");
	}

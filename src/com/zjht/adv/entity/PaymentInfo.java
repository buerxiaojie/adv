...
import com.zjht.adv.util.AppSignaturePair;
...
public class PaymentInfo {
	...
	public boolean isCallbackMatch() {
		boolean isCallbackMatch = AppSignaturePair.enCodeByCer(this.getCallbackSignStr(), this.getSignContent(), this.getPublicKeyName());
	...
	public String getSignContent() {
		...
		if (StringUtils.isBlank(this.signContent)) {
			this.signContent = AppSignaturePair.encodeMsgByPrivateKey(this.getPrivateKeyPath(), this.getSignStr(), this.getPrivateKeyPsw());
		}
		return signContent;
	}
	...
	public String getPrivateKeyPath() {
		return privateKeyPath != null ? privateKeyPath : PropertyUtil.getPropertyValueDir("app", "privateKeyName");
	}
	...
	public String getPrivateKeyPsw() {
		return privateKeyPsw != null ? privateKeyPsw : PropertyUtil.getPropertyValueDir("app", "privateKeyPsw");
	}
	...
	public String getPublicKeyName() {
		return publicKeyName != null ? publicKeyName : PropertyUtil.getPropertyValueDir("app", "pgpublicKeyName");
	}
	...
	public String getPlatformPayUrl() {
		return platformPayUrl != null ? platformPayUrl : PropertyUtil.getPropertyValueDir("app", "platform_pay_url");
	}

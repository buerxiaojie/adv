...
import com.zjht.adv.hprose.common.HproseCallback;
import com.zjht.adv.hprose.common.HproseErrorEvent;
import com.zjht.adv.hprose.common.HproseException;
import com.zjht.adv.hprose.common.HproseFilter;
import com.zjht.adv.hprose.common.HproseInvocationHandler;
import com.zjht.adv.hprose.common.HproseInvoker;
import com.zjht.adv.hprose.common.HproseResultMode;
import com.zjht.adv.hprose.io.HproseMode;
import com.zjht.adv.hprose.io.HproseReader;
import com.zjht.adv.hprose.io.HproseTags;
import com.zjht.adv.hprose.io.HproseWriter;
...
public abstract class HproseClient implements HproseInvoker {
    ...
    private void invoke(final String functionName, final Object[] arguments, @SuppressWarnings("rawtypes") final HproseCallback callback, final HproseErrorEvent errorEvent, final Type returnType, final boolean byRef, final HproseResultMode resultMode) {
        new Thread() {
            @Override
            public void run() {
                try {

...
//验证控件
$.validator.addMethod("mobel", function(value, element) {
    if ($(value).hasClass("required") && value == "")
        return false;

    if (value != "" && !isMobel(value))
        return false;
    else
        return true;
...
$.validator.addMethod("datetime", function (value, element) {
    ...
    if (value != "" && !ChkDateTime(value))
        return false;
    else
        return true;

}, "请输入合法的日期和时间,如2010-08-01 15:30:00");
...
/* leadwit add */
var tmp = "<div id='confirm'>";
tmp += "	<div class='header'><span>提示信息</span></div>";
tmp += "		<div class='message'></div>";
tmp += "		<div class='buttons'>";
tmp += "			<div class='no simplemodal-close'>取消</div><div class='yes'>确定</div>";
tmp += "		</div>";
tmp += "	</div>";

var tmp2 = "<div id='alert'>";
tmp2 += "	<div class='header'><span>提示信息</span></div>";
tmp2 += "		<div class='message'></div>";
tmp2 += "		<div class='buttons'>";
tmp2 += "			<div class='yes'>确定</div>";
tmp2 += "		</div>";
tmp2 += "	</div>";

function jqConfirm(message, callback, callback2) {
    $(tmp).modal({
...
function jqAlert(message, callback, callback2) {
    $(tmp2).modal({
        closeHTML: "<a href='#' title='Close' class='modal-close'>x</a>",
        position: ["35%", ],
        overlayId: 'confirm-overlay',
